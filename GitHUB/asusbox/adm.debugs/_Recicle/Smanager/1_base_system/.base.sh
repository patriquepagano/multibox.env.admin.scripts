...
echo "Download dos apks base..."
DownloadFiles="
https://www.dropbox.com/s/wh0zxa0yior8ohr/com.xyz.fullscreenbrowser.apk
https://www.dropbox.com/s/ieqlzvqp9s0mnu3/de.ozerov.fully.apk
https://www.dropbox.com/s/j5024pktdk6u8bd/Lightning.apk
https://www.dropbox.com/s/o28z2pz0gt29qlt/MiXplorer.apk
https://www.dropbox.com/s/xwrier2rkapw2qq/4_jp.gr.java_conf.ntmst118.quickhomeswitcher_2.0.0_4.apk
"
cd $baseapps/apk
for link in $DownloadFiles; do
while [ 1 ]; do
...
if [ "$CheckRoot" == "0" ] ; then
		...
		su -c $APPFolder/sc/.pm_install_base.sh
		rm $APPFolder/sc/.pm_install_base.sh
		# # open sshdroid
