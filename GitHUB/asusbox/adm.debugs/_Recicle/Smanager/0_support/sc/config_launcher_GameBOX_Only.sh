...
<map>
    <string name="application_00">com.retroarch</string>
	<string name="application_01">de.ozerov.fully</string>
    <string name="application_02">os.tools.scriptmanager</string>
    <string name="application_03">com.siriusapplications.quickboot</string>
</map>
EOF
chmod 660 $file
...
<map>
    ...
    <string name="preference_grid_y">2</string>
    <string name="preference_grid_x">2</string>
