...
# 1update.sh
# sistema básico de instalaçao da box ilimitado para sempre (desde que passe no chaveamento)
...
#####################################################################################################
# rootsudaemon.sh atualiza a partir do que tiver dentro do pack local
