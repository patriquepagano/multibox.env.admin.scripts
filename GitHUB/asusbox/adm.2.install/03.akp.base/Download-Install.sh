...
if [ ! "$cronRunning" == "yes" ]; then
    ...
    echo "<h1>$(date)</h1>" > $bootLog 2>&1
    echo "<h2>Iniciando Atualização</h2>" >> $bootLog 2>&1
...
####################### AKP Results >>> Wed Dec 31 21:40:32 BRT 1969
Senha7z=a5sd76f54a7s6f4as76d54f675sda4f67sd5a4f67sa5d4f67asd4f76sad4fs6da
apkName="akpb.001"
app="launcher.offline"
versionNameOnline="1.41"
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
SourcePack="/data/asusbox/.install/03.akp.base/akpb.001/AKP/akpb.001.AKP"
AKPouDTF="AKP"
LauncherIntegrated="OficialOffLine"
excludeListAPP
excludeListPack "/data/asusbox/.install/03.akp.base/akpb.001"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### DTF Results >>> Wed Dec 31 21:40:32 BRT 1969
apkName="akpb.001"
app="launcher.offline"
versionNameOnline="Wed Dec 31 21:40:10 BRT 1969"
SourcePack="/data/asusbox/.install/03.akp.base/akpb.001/DTF/akpb.001.DTF"
excludeListPack "/data/asusbox/.install/03.akp.base/akpb.001"
# Verifica se os arquivos locais estao atualizados
#CheckDownloadFiles
# se o data estiver limpo ou sem arquivo set vai aplicar
if [ ! -f "/data/data/launcher.offline/Wed Dec 31 21:40:10 BRT 1969" ] ; then
    ...
    ln -sf /data/app/launcher.offline-*/lib/arm /data/data/launcher.offline/lib
    ###################################################################################
    # permissoes do app
    AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
    AppGrant
    ...
    date > "/data/data/launcher.offline/Wed Dec 31 21:40:10 BRT 1969"
fi
###################################################################################
...
echo "ADM DEBUG #####################################################################"
echo "ADM DEBUG ### Ativa a launcher instalando apps quando não se tem os apps base"
...
Senha7z=a5sd76f54a7s6f4as76d54f675sda4f67sd5a4f67sa5d4f67asd4f76sad4fs6da
apkName="akpb.002"
app="com.not.aa_image_viewer"
versionNameOnline="0.9533"
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
SourcePack="/data/asusbox/.install/03.akp.base/akpb.002/AKP/akpb.002.AKP"
AKPouDTF="AKP"
LauncherIntegrated="no"
excludeListAPP
excludeListPack "/data/asusbox/.install/03.akp.base/akpb.002"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******
...
apkName="akpb.002"
app="com.not.aa_image_viewer"
versionNameOnline="Sun Nov 29 12:08:57 BRT 2020"
SourcePack="/data/asusbox/.install/03.akp.base/akpb.002/DTF/akpb.002.DTF"
excludeListPack "/data/asusbox/.install/03.akp.base/akpb.002"
# Verifica se os arquivos locais estao atualizados
#CheckDownloadFiles
# se o data estiver limpo ou sem arquivo set vai aplicar
if [ ! -f "/data/data/com.not.aa_image_viewer/Sun Nov 29 12:08:57 BRT 2020" ] ; then
    pm clear com.not.aa_image_viewer
    extractDTFSplitted
    ###################################################################################
    # manualDTFfix
    ...
    ###################################################################################
    # atualiza o symlink das libs em caso de atualização de apk
    ln -sf /data/app/com.not.aa_image_viewer-*/lib/arm /data/data/com.not.aa_image_viewer/lib
    ###################################################################################
    # permissoes do app
    AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
    AppGrant
    ...
    # abre o app para resolver o bug do mesmo
    monkey -p $app -c android.intent.category.LAUNCHER 1
    sleep 1
    am force-stop $app
    ...
    ###################################################################################
    # cria o marcador para não rodar isto sempre
    date > "/data/data/com.not.aa_image_viewer/Sun Nov 29 12:08:57 BRT 2020"
fi
###################################################################################
# config forçada para rodar sempre no boot

####################### AKP Results >>> Wed Dec 31 21:40:33 BRT 1969
Senha7z=a5sd76f54a7s6f4as76d54f675sda4f67sd5a4f67sa5d4f67asd4f76sad4fs6da
apkName="akpb.003"
app="dxidev.toptvlauncher2"
versionNameOnline="1.39"
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
