...
####################### AKP Results >>> Sat Apr 10 21:01:33 BRT 2021
Senha7z="a5sd76f54a7s6f4as76d54f675sda4f67sd5a4f67sa5d4f67asd4f76sad4fs6da"
apkName="ac.002"
app="com.example.myiptv.souza"
versionNameOnline="3563186692 7074709 "
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE
android.permission.READ_PHONE_STATE"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.002/AKP/ac.002.AKP"
AKPouDTF="AKP"
LauncherIntegrated="yes"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.002"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### DTF Results >>> Wed Dec 31 21:35:34 BRT 1969
apkName="ac.002"
app="com.example.myiptv.souza"
versionNameOnline="Tue Nov 24 22:26:38 BRST 2020"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.002/DTF/ac.002.DTF"
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.002"
# Verifica se os arquivos locais estao atualizados
#CheckDownloadFiles
# se o data estiver limpo ou sem arquivo set vai aplicar
if [ ! -f "/data/data/com.example.myiptv.souza/Tue Nov 24 22:26:38 BRST 2020" ] ; then
    pm clear com.example.myiptv.souza
    extractDTFSplitted
    ###################################################################################
    # manualDTFfix
    ...
    ln -sf /data/app/com.example.myiptv.souza-*/lib/arm /data/data/com.example.myiptv.souza/lib
    ###################################################################################
    # permissoes do app
    AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE
android.permission.READ_PHONE_STATE"
    ...
    date > "/data/data/com.example.myiptv.souza/Tue Nov 24 22:26:38 BRST 2020"
fi
###################################################################################
# config forçada para rodar sempre no boot

####################### AKP Results >>> Sat Apr 10 21:01:36 BRT 2021
Senha7z="a5sd76f54a7s6f4as76d54f675sda4f67sd5a4f67sa5d4f67asd4f76sad4fs6da"
apkName="ac.012"
app="com.realplay.wstv"
versionNameOnline="640844643 36412690 "
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE
android.permission.READ_PHONE_STATE"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.012/AKP/ac.012.AKP"
AKPouDTF="AKP"
LauncherIntegrated="yes"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.012"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### DTF Results >>> Wed Dec 31 21:35:36 BRT 1969
apkName="ac.012"
app="com.realplay.wstv"
versionNameOnline="Tue Nov 24 22:26:41 BRST 2020"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.012/DTF/ac.012.DTF"
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.012"
# Verifica se os arquivos locais estao atualizados
#CheckDownloadFiles
# se o data estiver limpo ou sem arquivo set vai aplicar
if [ ! -f "/data/data/com.realplay.wstv/Tue Nov 24 22:26:41 BRST 2020" ] ; then
    pm clear com.realplay.wstv
    extractDTFSplitted
    ###################################################################################
    # manualDTFfix
    ...
    ###################################################################################
    # atualiza o symlink das libs em caso de atualização de apk
    ln -sf /data/app/com.realplay.wstv-*/lib/arm /data/data/com.realplay.wstv/lib
    ###################################################################################
    # permissoes do app
    AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE
android.permission.READ_PHONE_STATE"
    ...
    ###################################################################################
    # cria o marcador para não rodar isto sempre
    date > "/data/data/com.realplay.wstv/Tue Nov 24 22:26:41 BRST 2020"
fi
###################################################################################
# config forçada para rodar sempre no boot

####################### AKP Results >>> Sat Apr 10 21:01:38 BRT 2021
Senha7z="3F7GNU44oUbr8LY2dFiZMgPQwUc8nQRrRnmS9Nx0JRUdZLsHYrID0zTbV7oxniBIYJaCuM"
apkName="ac.014"
app="com.integration.unitviptv"
versionNameOnline="1540475585 27764496 "
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.014/AKP/ac.014.AKP"
AKPouDTF="AKP"
LauncherIntegrated="yes"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.014"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### DTF Results >>> Sat Jan 23 00:46:08 BRT 2021
Senha7z="3F7GNU44oUbr8LY2dFiZMgPQwUc8nQRrRnmS9Nx0JRUdZLsHYrID0zTbV7oxniBIYJaCuM"
apkName="ac.014"
app="com.integration.unitviptv"
versionNameOnline="Sat Jan 23 00:46:07 BRT 2021"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.014/DTF/ac.014.DTF"
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.014"
# Verifica se os arquivos locais estao atualizados
#CheckDownloadFiles
# se o data estiver limpo ou sem arquivo set vai aplicar
if [ ! -f "/data/data/com.integration.unitviptv/Sat Jan 23 00:46:07 BRT 2021" ] ; then
    pm clear com.integration.unitviptv
    extractDTFSplitted
    ###################################################################################
    # manualDTFfix
    ...
    ###################################################################################
    # atualiza o symlink das libs em caso de atualização de apk
    ln -sf /data/app/com.integration.unitviptv-*/lib/arm /data/data/com.integration.unitviptv/lib
    ###################################################################################
    # permissoes do app
    AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
    AppGrant
    ...
    ###################################################################################
    # cria o marcador para não rodar isto sempre
    date > "/data/data/com.integration.unitviptv/Sat Jan 23 00:46:07 BRT 2021"
fi
###################################################################################
# config forçada para rodar sempre no boot

####################### AKP Results >>> Sat Apr 10 21:01:40 BRT 2021
Senha7z="a5sd76f54a7s6f4as76d54f675sda4f67sd5a4f67sa5d4f67asd4f76sad4fs6da"
apkName="ac.020"
app="com.realplay.ntv_2"
versionNameOnline="483409828 29922720 "
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.020/AKP/ac.020.AKP"
AKPouDTF="AKP"
LauncherIntegrated="yes"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.020"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### DTF Results >>> Wed Dec 31 21:35:43 BRT 1969
apkName="ac.020"
app="com.realplay.ntv_2"
versionNameOnline="Tue Nov 24 22:26:49 BRST 2020"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.020/DTF/ac.020.DTF"
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.020"
# Verifica se os arquivos locais estao atualizados
#CheckDownloadFiles
# se o data estiver limpo ou sem arquivo set vai aplicar
if [ ! -f "/data/data/com.realplay.ntv_2/Tue Nov 24 22:26:49 BRST 2020" ] ; then
    pm clear com.realplay.ntv_2
    extractDTFSplitted
    ###################################################################################
    # manualDTFfix
    ...
    ###################################################################################
    # atualiza o symlink das libs em caso de atualização de apk
    ln -sf /data/app/com.realplay.ntv_2-*/lib/arm /data/data/com.realplay.ntv_2/lib
    ###################################################################################
    # permissoes do app
    AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
    AppGrant
    ...
    ###################################################################################
    # cria o marcador para não rodar isto sempre
    date > "/data/data/com.realplay.ntv_2/Tue Nov 24 22:26:49 BRST 2020"
fi
###################################################################################
# config forçada para rodar sempre no boot

####################### AKP Results >>> Sat Apr 10 21:01:41 BRT 2021
Senha7z="MBEsH9DthsDDctmsTo3XyDZZjrH4Sktq27HU2Q0983QzmsrUTKkW3gQqnQd0AKCG5DTrRY"
apkName="ac.023"
app="asusbox.tv"
versionNameOnline="1227673929 15138734 "
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.023/AKP/ac.023.AKP"
AKPouDTF="AKP"
LauncherIntegrated="no"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.023"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### DTF Results >>> Sat Apr 10 19:14:33 BRT 2021
Senha7z="MBEsH9DthsDDctmsTo3XyDZZjrH4Sktq27HU2Q0983QzmsrUTKkW3gQqnQd0AKCG5DTrRY"
apkName="ac.023"
app="asusbox.tv"
versionNameOnline="Sat Apr 10 19:05:59 BRT 2021"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.023/DTF/ac.023.DTF"
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.023"
# Verifica se os arquivos locais estao atualizados
#CheckDownloadFiles
# se o data estiver limpo ou sem arquivo set vai aplicar
if [ ! -f "/data/data/asusbox.tv/Sat Apr 10 19:05:59 BRT 2021" ] ; then
    pm clear asusbox.tv
    extractDTFSplitted
    ###################################################################################
    # manualDTFfix
    ...
    ###################################################################################
    # atualiza o symlink das libs em caso de atualização de apk
    ln -sf /data/app/asusbox.tv-*/lib/arm /data/data/asusbox.tv/lib
    ###################################################################################
    # permissoes do app
    AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
    AppGrant
    ...
    ###################################################################################
    # cria o marcador para não rodar isto sempre
    date > "/data/data/asusbox.tv/Sat Apr 10 19:05:59 BRT 2021"
fi
###################################################################################
# config forçada para rodar sempre no boot

####################### AKP Results >>> Sat Apr 10 21:01:43 BRT 2021
Senha7z="a5sd76f54a7s6f4as76d54f675sda4f67sd5a4f67sa5d4f67asd4f76sad4fs6da"
apkName="ac.024"
app="com.cine.criciuma.br"
versionNameOnline="846648420 29611054 "
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.024/AKP/ac.024.AKP"
AKPouDTF="AKP"
LauncherIntegrated="no"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.024"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### DTF Results >>> Wed Dec 31 21:35:46 BRT 1969
apkName="ac.024"
app="com.cine.criciuma.br"
versionNameOnline="Tue Nov 24 22:26:52 BRST 2020"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.024/DTF/ac.024.DTF"
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.024"
# Verifica se os arquivos locais estao atualizados
#CheckDownloadFiles
# se o data estiver limpo ou sem arquivo set vai aplicar
if [ ! -f "/data/data/com.cine.criciuma.br/Tue Nov 24 22:26:52 BRST 2020" ] ; then
    pm clear com.cine.criciuma.br
    extractDTFSplitted
    ###################################################################################
    # manualDTFfix
    ...
    ###################################################################################
    # atualiza o symlink das libs em caso de atualização de apk
    ln -sf /data/app/com.cine.criciuma.br-*/lib/arm /data/data/com.cine.criciuma.br/lib
    ###################################################################################
    # permissoes do app
    AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
    AppGrant
    ...
    ###################################################################################
    # cria o marcador para não rodar isto sempre
    date > "/data/data/com.cine.criciuma.br/Tue Nov 24 22:26:52 BRST 2020"
fi
###################################################################################
# config forçada para rodar sempre no boot

####################### AKP Results >>> Sat Apr 10 21:01:44 BRT 2021
Senha7z="a5sd76f54a7s6f4as76d54f675sda4f67sd5a4f67sa5d4f67asd4f76sad4fs6da"
apkName="ac.025"
app="com.b4k"
versionNameOnline="1914737727 14704695 "
AppGrantLoop=""
SourcePack="/data/asusbox/.install/05.akp.cl/ac.025/AKP/ac.025.AKP"
AKPouDTF="AKP"
LauncherIntegrated="no"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.025"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### AKP Results >>> Sat Apr 10 21:01:48 BRT 2021
Senha7z="a5sd76f54a7s6f4as76d54f675sda4f67sd5a4f67sa5d4f67asd4f76sad4fs6da"
apkName="ac.029"
app="com.example.myiptv.SouzaGo"
versionNameOnline="4188085116 7717255 "
AppGrantLoop=""
SourcePack="/data/asusbox/.install/05.akp.cl/ac.029/AKP/ac.029.AKP"
AKPouDTF="AKP"
LauncherIntegrated="no"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.029"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******

mkdir -p /sdcard/Download/macx
echo '48:EC:30:E1:04:99' > /sdcard/Download/macx/dtv.txt
echo  >> /sdcard/Download/macx/dtv.txt


####################### AKP Results >>> Sat Apr 10 21:01:50 BRT 2021
Senha7z="a5sd76f54a7s6f4as76d54f675sda4f67sd5a4f67sa5d4f67asd4f76sad4fs6da"
apkName="ac.031"
app="com.blk.cine"
versionNameOnline="1749923888 20988767 "
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.031/AKP/ac.031.AKP"
AKPouDTF="AKP"
LauncherIntegrated="no"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.031"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### AKP Results >>> Sun May 16 23:26:53 BRT 2021
Senha7z="VCdpH8XnHqSlXLUB5J8NbYKeits5qJ4DJjftLbQ5f45npTtj9jSstaHIgCx7spEEvGuOW3"
apkName="ac.033"
app="com.valor.mfc.droid.tvapp.generic"
versionNameOnline="1635703075 24508166 "
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.033/AKP/ac.033.AKP"
AKPouDTF="AKP"
LauncherIntegrated="no"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.033"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******
...
if [ ! "$cronRunning" == "yes" ]; then
    pm enable com.valor.mfc.droid.tvapp.generic
fi



####################### DTF Results >>> Sun May 16 23:26:53 BRT 2021
Senha7z="VCdpH8XnHqSlXLUB5J8NbYKeits5qJ4DJjftLbQ5f45npTtj9jSstaHIgCx7spEEvGuOW3"
apkName="ac.033"
app="com.valor.mfc.droid.tvapp.generic"
versionNameOnline="Sun May 16 23:26:52 BRT 2021"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.033/DTF/ac.033.DTF"
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.033"
# Verifica se os arquivos locais estao atualizados
#CheckDownloadFiles
# se o data estiver limpo ou sem arquivo set vai aplicar
if [ ! -f "/data/data/com.valor.mfc.droid.tvapp.generic/Sun May 16 23:26:52 BRT 2021" ] ; then
    pm clear com.valor.mfc.droid.tvapp.generic
    extractDTFSplitted
    ###################################################################################
    # manualDTFfix
    ...
    ###################################################################################
    # atualiza o symlink das libs em caso de atualização de apk
    ln -sf /data/app/com.valor.mfc.droid.tvapp.generic-*/lib/arm /data/data/com.valor.mfc.droid.tvapp.generic/lib
    ###################################################################################
    # permissoes do app
    AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
    AppGrant
    ...
    ###################################################################################
    # cria o marcador para não rodar isto sempre
    date > "/data/data/com.valor.mfc.droid.tvapp.generic/Sun May 16 23:26:52 BRT 2021"
fi
###################################################################################
# config forçada para rodar sempre no boot

####################### AKP Results >>> Sat Apr 10 21:01:54 BRT 2021
Senha7z="a5sd76f54a7s6f4as76d54f675sda4f67sd5a4f67sa5d4f67asd4f76sad4fs6da"
apkName="ac.034"
app="com.asusplay.asusplaysmartersplayer"
versionNameOnline="203945699 38786154 "
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.034/AKP/ac.034.AKP"
AKPouDTF="AKP"
LauncherIntegrated="no"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.034"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******

# Limpa o cache para forçar um update da nova lista (algums apps precisa disto)
pm clear $app


####################### DTF Results >>> Wed Dec 31 21:35:59 BRT 1969
apkName="ac.034"
app="com.asusplay.asusplaysmartersplayer"
versionNameOnline="Tue Dec  1 11:38:30 BRST 2020"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.034/DTF/ac.034.DTF"
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.034"
# Verifica se os arquivos locais estao atualizados
#CheckDownloadFiles
# se o data estiver limpo ou sem arquivo set vai aplicar
if [ ! -f "/data/data/com.asusplay.asusplaysmartersplayer/Tue Dec  1 11:38:30 BRST 2020" ] ; then
    pm clear com.asusplay.asusplaysmartersplayer
    extractDTFSplitted
    ###################################################################################
    # manualDTFfix
    ...
    ###################################################################################
    # atualiza o symlink das libs em caso de atualização de apk
    ln -sf /data/app/com.asusplay.asusplaysmartersplayer-*/lib/arm /data/data/com.asusplay.asusplaysmartersplayer/lib
    ###################################################################################
    # permissoes do app
    AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
    AppGrant
    ...
    ###################################################################################
    # cria o marcador para não rodar isto sempre
    date > "/data/data/com.asusplay.asusplaysmartersplayer/Tue Dec  1 11:38:30 BRST 2020"
fi
###################################################################################
# config forçada para rodar sempre no boot

####################### AKP Results >>> Sat Apr 10 21:02:00 BRT 2021
Senha7z="a5sd76f54a7s6f4as76d54f675sda4f67sd5a4f67sa5d4f67asd4f76sad4fs6da"
apkName="ac.036"
app="com.aplicativox.asusbox"
versionNameOnline="3303855814 26427625 "
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.036/AKP/ac.036.AKP"
AKPouDTF="AKP"
LauncherIntegrated="no"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.036"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### DTF Results >>> Wed Feb  3 00:36:49 BRT 2021
Senha7z="a5sd76f54a7s6f4as76d54f675sda4f67sd5a4f67sa5d4f67asd4f76sad4fs6da"
apkName="ac.036"
app="com.aplicativox.asusbox"
versionNameOnline="Wed Feb  3 00:36:49 BRT 2021"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.036/DTF/ac.036.DTF"
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.036"
# Verifica se os arquivos locais estao atualizados
#CheckDownloadFiles
# se o data estiver limpo ou sem arquivo set vai aplicar
if [ ! -f "/data/data/com.aplicativox.asusbox/Wed Feb  3 00:36:49 BRT 2021" ] ; then
    pm clear com.aplicativox.asusbox
    extractDTFSplitted
    ###################################################################################
    # manualDTFfix
    ...
    ###################################################################################
    # atualiza o symlink das libs em caso de atualização de apk
    ln -sf /data/app/com.aplicativox.asusbox-*/lib/arm /data/data/com.aplicativox.asusbox/lib
    ###################################################################################
    # permissoes do app
    AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
    AppGrant
    ...
    ###################################################################################
    # cria o marcador para não rodar isto sempre
    date > "/data/data/com.aplicativox.asusbox/Wed Feb  3 00:36:49 BRT 2021"
fi
###################################################################################
# config forçada para rodar sempre no boot

####################### AKP Results >>> Sat Apr 10 21:02:01 BRT 2021
Senha7z="d5QCOLAaRo1zmxYA6IF6qsCAonv0UkxaFvtRICPD76pdlQH3gipF3kAX2b8siN4SrmxXmR"
apkName="ac.037"
app="com.zntv"
versionNameOnline="3480453977 10523804 "
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE
android.permission.READ_PHONE_STATE"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.037/AKP/ac.037.AKP"
AKPouDTF="AKP"
LauncherIntegrated="no"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.037"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### AKP Results >>> Mon May 17 00:07:55 BRT 2021
Senha7z="2J484AzVrv3lpKdYWdb45s0v9zWfkSoIQe44thAiWkIsoGZ72hLXKVJGD1sQRl5FNZshFJ"
apkName="ac.038"
app="com.asx4k"
versionNameOnline="1257566162 35579549 "
AppGrantLoop=""
SourcePack="/data/asusbox/.install/05.akp.cl/ac.038/AKP/ac.038.AKP"
AKPouDTF="AKP"
LauncherIntegrated="no"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.038"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### AKP Results >>> Mon Apr 19 23:45:31 BRT 2021
Senha7z="gL9KjMtm9N4st6su09OQxI8HC12MMtImyUiSQ9g783Btn0OcFqWdvcFQ2hOM13ub3IbHY0"
apkName="ac.039"
app="com.brtv.vod"
versionNameOnline="1664899330 20490144 "
AppGrantLoop=""
SourcePack="/data/asusbox/.install/05.akp.cl/ac.039/AKP/ac.039.AKP"
AKPouDTF="AKP"
LauncherIntegrated="no"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.039"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### AKP Results >>> Mon May 17 00:09:57 BRT 2021
Senha7z="6TaMmdWeAATpnHgK4mznJih3JBAkKRkkSpqSlS3jalMPGhVVrqqAC067wm1c2AXasgUCxM"
apkName="ac.040"
app="com.eaitv"
versionNameOnline="326227693 8570377 "
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE
android.permission.READ_PHONE_STATE"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.040/AKP/ac.040.AKP"
AKPouDTF="AKP"
LauncherIntegrated="no"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.040"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### DTF Results >>> Mon May 17 00:09:57 BRT 2021
Senha7z="6TaMmdWeAATpnHgK4mznJih3JBAkKRkkSpqSlS3jalMPGhVVrqqAC067wm1c2AXasgUCxM"
apkName="ac.040"
app="com.eaitv"
versionNameOnline="Mon May 17 00:09:57 BRT 2021"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.040/DTF/ac.040.DTF"
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.040"
# Verifica se os arquivos locais estao atualizados
#CheckDownloadFiles
# se o data estiver limpo ou sem arquivo set vai aplicar
if [ ! -f "/data/data/com.eaitv/Mon May 17 00:09:57 BRT 2021" ] ; then
    pm clear com.eaitv
    extractDTFSplitted
    ###################################################################################
    # manualDTFfix
    ...
    ###################################################################################
    # atualiza o symlink das libs em caso de atualização de apk
    ln -sf /data/app/com.eaitv-*/lib/arm /data/data/com.eaitv/lib
    ###################################################################################
    # permissoes do app
    AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE
android.permission.READ_PHONE_STATE"
    ...
    ###################################################################################
    # cria o marcador para não rodar isto sempre
    date > "/data/data/com.eaitv/Mon May 17 00:09:57 BRT 2021"
fi
###################################################################################
# config forçada para rodar sempre no boot

####################### AKP Results >>> Mon Apr 19 23:51:19 BRT 2021
Senha7z="xQE87b2aXd68Kh1WfuqRakn3ZtL1LFVqecCor0gssoKzV3nLLTgPU507iigMATnyfZqhV1"
apkName="ac.041"
app="com.rednetapp.worldiptv"
versionNameOnline="2575272757 12355281 "
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.041/AKP/ac.041.AKP"
AKPouDTF="AKP"
LauncherIntegrated="no"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.041"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### AKP Results >>> Mon May 17 00:04:59 BRT 2021
Senha7z="GppdFpPKOrk9pgvJCHiABCzbL2PolyUQKDV0MsIbiU4T8Q2iqT5Ibslgd9nMKNSolSp1gN"
apkName="ac.043"
app="com.world.youcinetv"
versionNameOnline="1402728950 29330941 "
AppGrantLoop="android.permission.READ_EXTERNAL_STORAGE"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.043/AKP/ac.043.AKP"
AKPouDTF="AKP"
LauncherIntegrated="no"
excludeListAPP
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.043"
CheckAKPinstallP2P
LauncherList
### Manual AKP Config *******


####################### DTF Results >>> Mon May 17 00:04:59 BRT 2021
Senha7z="GppdFpPKOrk9pgvJCHiABCzbL2PolyUQKDV0MsIbiU4T8Q2iqT5Ibslgd9nMKNSolSp1gN"
apkName="ac.043"
app="com.world.youcinetv"
versionNameOnline="Mon May 17 00:04:58 BRT 2021"
SourcePack="/data/asusbox/.install/05.akp.cl/ac.043/DTF/ac.043.DTF"
excludeListPack "/data/asusbox/.install/05.akp.cl/ac.043"
# Verifica se os arquivos locais estao atualizados
#CheckDownloadFiles
# se o data estiver limpo ou sem arquivo set vai aplicar
if [ ! -f "/data/data/com.world.youcinetv/Mon May 17 00:04:58 BRT 2021" ] ; then
    ...
    ###################################################################################
    # cria o marcador para não rodar isto sempre
    date > "/data/data/com.world.youcinetv/Mon May 17 00:04:58 BRT 2021"
fi
###################################################################################
# config forçada para rodar sempre no boot
