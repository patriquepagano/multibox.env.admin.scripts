...
pkg install -y git openssh tsu p7zip mc screen ncdu htop
pkg install -y rclone sshpass
pkg install -y transmission wget curl rsync
pkg install -y libacl
pkg install -y python
pkg install -y lighttpd
pkg install -y shc file
