...
# echo "**index-v0.14.0.db
# termux/files/usr/" > /storage/DevMount/asusbox/.stignore


cat << EOF > "/data/local/tmp/Simport.json"
{
  "id": "3pt4x-lpekx",
  "label": "TVBox asubox .install",
  "filesystemType": "basic",
  "path": "/storage/DevMount/asusbox",
  "type": "sendonly",
  "devices": [
EOF
...
curl -u "$User":"$User" -X POST -H "X-API-Key: $API" "http://127.0.0.1:$WebPort/rest/db/override?folder=3pt4x-lpekx"
