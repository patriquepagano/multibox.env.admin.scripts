...
# fixar a permissão do MixPlorer? pegou em todos os explorer apps!
busybox chmod 777 -R /storage/DevMount/4Android
busybox chown 10026:10026 -R /storage/DevMount/4Android
busybox mount -o bind /storage/DevMount/4Android /mnt/runtime/read/emulated/0/Download
busybox mount -o bind /storage/DevMount/4Android /mnt/runtime/write/emulated/0/Download
busybox mount -o bind /storage/DevMount/4Android /sdcard/Download
busybox mount -o bind /storage/DevMount/4Android /storage/emulated/0/Download
