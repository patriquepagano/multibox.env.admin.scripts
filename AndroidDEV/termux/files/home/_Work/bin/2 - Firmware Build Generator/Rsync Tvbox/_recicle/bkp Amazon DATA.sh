...
# backup
/system/bin/busybox tar -czvf "/data/trueDT/peer/Sync/cfg.uniq/$app.DT.tar.gz" "/data/data/com.amazon.avod.thirdpartyclient"
...
APP="/data/data/com.amazon.avod.thirdpartyclient"
