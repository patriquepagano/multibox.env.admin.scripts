...
path="/storage/asusboxUpdate/GitHUB/asusbox/adm.1.export/05.akp.cl"
path="/storage/DevMount/GitHUB/asusbox/adm.1.export/05.akp.cl"
...
# loop da lista
find "$path" -maxdepth 1 -name "ac.*.sh" | sort | while read fname; do
i=$((i+1))
cat <<EOF >> $scriptMenu
